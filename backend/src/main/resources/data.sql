...
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (2, 'Mint', 'East wall', 'Small mint plants', 1, 'admin', NOW(), 3, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (3, 'Parsley', 'South wall', 'Small parsley plants', 1, 'admin', NOW(), 4, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (4, 'Chives', 'West wall', 'Small chives plants', 1, 'admin', NOW(), 5, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (5, 'Rosemary', 'Center', 'Small rosemary plants', 1, 'admin', NOW(), 6, FALSE);
...
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (7, 'Cilantro', 'East wall', 'Small cilantro plants', 1, 'admin', NOW(), 2, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (8, 'Oregano', 'South wall', 'Small oregano plants', 1, 'admin', NOW(), 3, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (9, 'Sage', 'West wall', 'Small sage plants', 1, 'admin', NOW(), 4, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (10, 'Dill', 'Center', 'Small dill plants', 1, 'admin', NOW(), 5, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (11, 'Aloe Vera', 'Sunny windowsill', 'Succulent plant with medicinal properties', 1, 'admin', NOW(), 6, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (12, 'Rosemary', 'East window', 'Aromatic herb with needle-like leaves', 1, 'admin', NOW(), 3, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (13, 'Mint', 'Kitchen counter', 'Refreshing herb used in tea and cooking', 1, 'admin', NOW(), 4, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (14, 'Cactus', 'Sunny windowsill', 'Low-maintenance plant that stores water in its stem', 1, 'admin', NOW(), 5, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (15, 'Lavender', 'South-facing balcony', 'Fragrant purple flowers used for essential oils', 1, 'admin', NOW(), 6, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (16, 'Spider Plant', 'Hanging basket', 'Easy to care for indoor plant with long leaves', 1, 'admin', NOW(), 7, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (17, 'Snake Plant', 'Living room corner', 'Tall, upright plant with sword-like leaves', 1, 'admin', NOW(), 2, FALSE);
...
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (2, 'Lettuce', 'Indoor hydroponic system', 'Leafy greens that grow in water', 2, 'admin', NOW(), 3, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (3, 'Peppers', 'West-facing window', 'Spicy fruit that grows on a bush', 2, 'admin', NOW(), 4, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (4, 'Strawberries', 'Hanging planter', 'Small, juicy fruit that grows on a runner', 2, 'admin', NOW(), 5, FALSE);
...
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (6, 'Chives', 'Indoor herb garden', 'Onion-like herb with long, thin leaves', 2, 'admin', NOW(), 7, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (7, 'Oregano', 'Sunny windowsill', 'Herb with pungent leaves used in Mediterranean cuisine', 2, 'admin', NOW(), 2, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (8, 'Thyme', 'Indoor herb garden', 'Herb with tiny, fragrant leaves used in soups and stews', 2, 'admin', NOW(), 3, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (9, 'Mint', 'Mason jar planter', 'Refreshing herb used in tea and cocktails', 2, 'admin', NOW(), 4, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (10, 'Cilantro', 'Indoor herb garden', 'Pungent herb used in Mexican and Asian cuisine', 2, 'admin', NOW(), 5, FALSE);

--Greenhouses for Access Point 3
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (1, 'Succulents', 'Sunny windowsill', 'Water-storing plants with thick, fleshy leaves', 3, 'admin', NOW(), 2, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (2, 'Spider plant', 'Hanging planter', 'Hardy plant with long, thin leaves that produce "spiderettes"', 3, 'admin', NOW(), 3, FALSE);
...
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (4, 'Snake plant', 'Sunny windowsill', 'Tall plant with stiff, upright leaves', 3, 'admin', NOW(), 5, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (5, 'Peace lily', 'Low-light area', 'Flowering plant with glossy, dark green leaves', 3, 'admin', NOW(), 6, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (6, 'Aloe vera', 'Sunny windowsill', 'Succulent plant with medicinal properties', 3, 'admin', NOW(), 7, FALSE);
...
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (9, 'English ivy', 'Hanging planter', 'Vining plant with small, variegated leaves', 3, 'admin', NOW(), 4, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (10, 'ZZ plant', 'Low-light area', 'Plant with thick, glossy leaves that require infrequent watering', 3, 'admin', NOW(), 5, FALSE);

--Greenhouses for Access Point 4
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (1, 'Tomatoes', 'South wall', 'Vining plant that produces juicy fruit', 4, 'admin', NOW(), 2, FALSE);
...
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (4, 'Cucumbers', 'East wall', 'Vining plant that produces refreshing fruit', 4, 'admin', NOW(), 5, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (5, 'Kale', 'East wall', 'Leafy green with a slightly bitter flavor', 4, 'admin', NOW(), 6, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (6, 'Radishes', 'North wall', 'Root vegetable with a crisp, peppery taste', 4, 'admin', NOW(), 7, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (7, 'Basil', 'South wall', 'Fragrant herb with many culinary uses', 4, 'admin', NOW(), 2, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (8, 'Spinach', 'East wall', 'Leafy green that is high in iron', 4, 'admin', NOW(), 3, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (9, 'Squash', 'South wall', 'Fruit-bearing plant with a hard outer shell', 4, 'admin', NOW(), 4, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (10, 'Chives', 'North wall', 'Herb with a mild onion-like flavor', 4, 'admin', NOW(), 5, FALSE);

--Greenhouses for Access Point 5
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (1, 'Strawberries', 'West wall', 'Small, sweet fruit that grows on runners', 5, 'admin', NOW(), 2, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (2, 'Basil', 'North wall', 'Aromatic herb with many culinary uses', 5, 'admin', NOW(), 3, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (3, 'Kale', 'East wall', 'Nutritious leafy green that can be used in many dishes', 5, 'admin', NOW(), 4, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (4, 'Chives', 'North wall', 'Mildly flavored herb that adds a hint of onion to dishes', 5, 'admin', NOW(), 5, FALSE);
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (5, 'Lettuce', 'East wall', 'Cool and crisp leafy green that is perfect for salads', 5, 'admin', NOW(), 6, FALSE);
...
INSERT INTO greenhouse(id_in_cluster, name, location, description, accesspoint_uuid, create_user_username, create_date, owner_id, published) VALUES (7, 'Peppers', 'South wall', 'Fruit-bearing plant that can be spicy or sweet', 5, 'admin', NOW(), 2, FALSE);
