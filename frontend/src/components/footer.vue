...
<template>
  <div class="footer-view display-flex w-[100vw]">
    <div class="wrapper space-x-40 flex">
      ...
      <div class="text-white flex-1">
        <p class="font-primary text-[20px] mb-3">Company:</p>
      ...
      <div class="text-white flex-1">
        <p class="font-primary text-[20px] mb-3">Services:</p>
    ...
    <div class="flex-1 flex-row">
      <p class="text-center font-secondary text-[16px] text-white opacity-60 ">Copyright ⓒ 2023. PlantHealth. All rights reserved.</p>
    </div>
  </div>
</template>
