  ...
  <v-app>
    ...
    <main-container negative>
      <div class="flex flex-wrap">
        ...
        <div class="mx-auto my-12 w-full h-full text-black flex-wrap flex flex-col">
          <img class="rounded-full w-64 h-64 object-cover shadow-lg bg"
               alt="avatar" src="https://upload.wikimedia.org/wikipedia/commons/2/2c/Default_pfp.svg">
